-- Table: public.regular_2022

-- DROP TABLE IF EXISTS public.regular_2022;

CREATE TABLE IF NOT EXISTS public.regular_2022_1_com_regiao
(
    "ANO" bigint,
    "EDICAO" bigint,
    "ETAPA" bigint,
...
ALTER TABLE IF EXISTS public.regular_2022_1_com_regiao
    OWNER to postgres;